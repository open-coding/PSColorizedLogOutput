#
# Modulmanifest für das Modul "PSGet_PSColorizedLogOutput"
#
...
RootModule = '.\PSColorizedLogOutput.psm1'
...
GUID = '207b0cad-d234-4e4b-bc4c-0395859c3cf3'
...
Description = 'Writes colorized output to host if LogLevel like INFO, DEBUG, ... can be found in the stream. Each loglevel has its own foreground-color.'
...
FunctionsToExport = 'Test-LogLevelFromLine', 'Write-HostWithColorizedLogLevels'
